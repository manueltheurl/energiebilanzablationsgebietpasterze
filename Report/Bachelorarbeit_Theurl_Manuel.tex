...
% WORTH GOLD .. MATH in normal font
\usepackage[
%   italic,
    symbolgreek
    ]{mathastext}
...
Ich danke an dieser Stelle meinem Betreuer Herrn Ass.-Prof. Dr. Abermann Jakob der mir einerseits viel Freiraum zur selbstständigen Gestaltung der Arbeit gelassen hat und mich andererseits tatkräftig mit tollen Ideen, zahlreicher wissenschaftlicher Literatur und nicht zuletzt persönlich bei zahlreichen Treffen unterstützt hat. Ein Dank geht außerdem auch an die Zentralanstalt für Meteorologie und Geodynamik, die mir Wetterdaten vom Ablationsgebiet der Pasterze zur Verfügung gestellt hat.\\
