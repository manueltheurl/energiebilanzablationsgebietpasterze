...
Es stellt sich heraus, dass der genannte hohe Wert der Energiebilanz, siehe Abbildung \ref{fig:Sensible Hitze im gesamten Messzeitraum}, bei der sensiblen Wräme auftritt. In der Berechnung der sensiblen Hitze fließen die Messgrößen Luftdruck, Windgeschwindigkeit, Lufttemperatur und Eistemperatur mit ein. Bei genauerer Betrachtung der Messwerte fallen insbesondere hohe TODO Temperaturen  und evtl Hitzesommer nachweis Literatur Zeitungsartikel oder ähnliches???
...
\caption{Energiebilanz im mgesamten Messzeitraum inklusive gemessenem und modellierten Schmelzwasser}
\label{fig:..}
\end{figure}
