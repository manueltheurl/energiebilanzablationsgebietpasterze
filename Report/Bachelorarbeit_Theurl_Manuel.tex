...
Als Ergebnis folgt mit $\Delta I = 252.5~cm,$, dass in den betrachteten 100 Jahren die Eisdicke im Ablationsgebiet der Pasterze bei Betrachtng der Sommermonate um ca. $\mathbf{2.5~m}$ \textbf{weniger abgenommen} hätte, wenn die kurzwellige Strahlung seit dem Jahr 1900 konstant geblieben wäre.
